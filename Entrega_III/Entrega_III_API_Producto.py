...
url = "https://tzgipxjlrkyvfgo.form.io/producto/submission?limit=10"
...
for elemento in data: 
    try:
        ...
        mySql_insert_query = f"""INSERT INTO producto (linea,dimensiones,costo) 
        VALUES (
        '{elemento['data']['linea']}',
        '{elemento['data']['dimensiones']}',
        '{elemento['data']['costo']}') """
